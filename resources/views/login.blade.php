...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2); min-height:55px;">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b><img src="/logo/pemko.png" width="5%"> SIMASGOSIN</b></a>
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/logo/b.jpeg');">
    <div class="container">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <h1 style="font-family: 'cocoon', sans-serif;">LOGIN</h1>
          </div>
